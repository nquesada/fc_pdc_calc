...
rb_ana = np.loadtxt(path + 'raw_data/rb_ana.txt.gz').view(complex)
rb_num = np.loadtxt(path + 'raw_data/rb_num.txt.gz').view(complex)

va_rig = np.loadtxt(path + 'raw_data/va_rig.txt.gz').view(complex)
ua_rig = np.loadtxt(path + 'raw_data/ua_rig.txt.gz').view(complex)
vb_rig = np.loadtxt(path + 'raw_data/vb_rig.txt.gz').view(complex)
ub_rig = np.loadtxt(path + 'raw_data/ub_rig.txt.gz').view(complex)
...
ua_ana , va_ana, ub_ana, vb_ana = lib.construct_u_and_v(ra_ana, pdc_properties['w_step'], wRange)


# Construct U and V for the numerical solution
ua_num, va_num, ub_num, vb_num = lib.construct_u_and_v(ra_num, pdc_properties['w_step'], wRange)
...
def construct_rig_solution_ua_and_ub_from_v_rig(v, w_step):
    ...
    # Correct for w_step to get actual va_amplitudes
    vD = vD * w_step
    rD = np.arcsinh(vD)
    ...
    # Construct U_b  and V_b
    # The complete solution is reconstructed from a single-matrix otherwise the
    # phase factors don't work out
...
# Reconstruct the rigorous solution from a given v_rig. This enables us later
# to plot the ua_rig and ub_rig functions without any numerical issues.
ua_rec, va_rec, ub_rec, vb_rec = \
        construct_rig_solution_ua_and_ub_from_v_rig(va_rig, pdc_properties['w_step'])
...
np.savetxt(path + "/U_and_V_matrices/data/ana/vb_ana.txt.gz", vb_ana.view(float))
np.savetxt(path + "/U_and_V_matrices/data/ana/ub_ana.txt.gz", ub_ana.view(float))
...
np.savetxt(path + "/U_and_V_matrices/data/num/vb_num.txt.gz", vb_num.view(float))
np.savetxt(path + "/U_and_V_matrices/data/num/ub_num.txt.gz", ub_num.view(float))
...
np.savetxt(path + "/U_and_V_matrices/data/rig/vb_rig.txt.gz", vb_rig.view(float))
np.savetxt(path + "/U_and_V_matrices/data/rig/ub_rig.txt.gz", ub_rig.view(float))
...
np.savetxt(path + "/U_and_V_matrices/data/rec/vb_rec.txt.gz", vb_rec.view(float))
np.savetxt(path + "/U_and_V_matrices/data/rec/ub_rec.txt.gz", ub_rec.view(float))
...
plt.subplot(2,3,4)
plt.imshow(np.abs(ub_ana), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|U_b(\omega,\omega')|$")
plt.colorbar()

plt.subplot(2,3,5)
plt.imshow(np.abs(ub_ana - Uinitial), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|U_b(\omega,\omega')| - \delta(\omega-\omega')$")
plt.colorbar()

plt.subplot(2,3,6)
plt.imshow(np.abs(vb_ana), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|V_b(\omega, \omega')|$")
plt.colorbar()
...
plt.subplot(2,3,4)
plt.imshow(np.abs(ub_num), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|U_b(\omega,\omega')|$")
plt.colorbar()

plt.subplot(2,3,5)
plt.imshow(np.abs(ub_num - Uinitial), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|U_b(\omega,\omega')| - \delta(\omega-\omega')$")
plt.colorbar()

plt.subplot(2,3,6)
plt.imshow(np.abs(vb_num), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|V_b(\omega, \omega')|$")
plt.colorbar()
...
plt.subplot(2,3,4)
plt.imshow(np.abs(ub_rig), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|U_b(\omega,\omega')|$")
plt.colorbar()

plt.subplot(2,3,5)
plt.imshow(np.abs(ub_rig - Uinitial), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|U_b(\omega,\omega')| - \delta(\omega-\omega')$")
plt.colorbar()

plt.subplot(2,3,6)
plt.imshow(np.abs(vb_rig), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|V_b(\omega, \omega')|$")
plt.colorbar()
...
plt.subplot(2,3,4)
plt.imshow(np.abs(ub_rec), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|U_b(\omega,\omega')|$")
plt.colorbar()

plt.subplot(2,3,5)
plt.imshow(np.abs(ub_rec - Uinitial), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|U_b(\omega,\omega')| - \delta(\omega-\omega')$")
plt.colorbar()

plt.subplot(2,3,6)
plt.imshow(np.abs(vb_rec), origin="lower", cmap=plt.cm.hot , extent=(w_start, w_stop, w_start, w_stop) )
plt.title(r"$|V_b(\omega, \omega')|$")
plt.colorbar()
