...
# This script automates the analysis of the hdf5 files. One only has to specify the 
# input directory of the files to be evaluated and the output directory where the 
...
for input_file in $1*; do
    ...
    echo "####################################"
    echo "####################################"
    python analyse_PDC.py $input_file $output_file_directory
    echo "####################################"
