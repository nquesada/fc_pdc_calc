...
#! /usr/bin/env python
""" This script calculates the analytic and rigorous solution of an
uncorrelated frequency conversion process as given in the corresponding
...
#############################################
## Frequency conversion process parameters ##
#############################################
...
# Note: For testing purposes it is OK to work with step sizes of about 100.
# This reduces the runtime to a few mintures. However, in order to obtain
# numerically valid results, about 500 sampling points are necessary. 
...
################################################################
## Calculate the FC process using the above stated parameters ##
## and save the end result into a hdf5 file.                  ##
################################################################

calc_FC.calc_FC(coupling, w_start, w_stop, w_steps, z_start, z_stop, z_steps, A, B, C, pump_width, save_directory)

# Iterate over a range of coupling values
#coupling_range = np.arange(0.1, 2.1, 0.1)
